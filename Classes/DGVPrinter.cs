...
{    
    ...
    public class DGVPrinter
    {
        ...
        public DGVPrinter()
        {
            ...
            // set default fonts
            pagenofont = new Font("B Nazanin", 10, FontStyle.Regular, GraphicsUnit.Point);
            pagenocolor = Color.Black;
            titlefont = new Font("B Titr", 18, FontStyle.Bold, GraphicsUnit.Point);
            titlecolor = Color.Black;
            subtitlefont = new Font("B Karim", 12, FontStyle.Bold, GraphicsUnit.Point);
            subtitlecolor = Color.Black;
            footerfont = new Font("B Nazanin", 10, FontStyle.Bold, GraphicsUnit.Point);
            ...
            buildstringformat(ref titleformat, null, StringAlignment.Center, StringAlignment.Center,
                StringFormatFlags.NoWrap | StringFormatFlags.LineLimit | StringFormatFlags.NoClip | StringFormatFlags.DirectionRightToLeft, StringTrimming.Word);
            ...
            headercellformatflags = StringFormatFlags.LineLimit | StringFormatFlags.NoClip | StringFormatFlags.DirectionRightToLeft;
            cellalignment = StringAlignment.Near;
            cellformatflags = StringFormatFlags.LineLimit | StringFormatFlags.NoClip | StringFormatFlags.DirectionRightToLeft;
        }
